...
- [**Latest Configuration UI** (0.17.13) 🚀](https://dev.config-ui.demo.trustgraph.ai/)
...
| ------------ | --------------- |
| Latest | [0.17.13](https://github.com/trustgraph-ai/trustgraph/releases/download/v0.17.13/deploy.zip) |
