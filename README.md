...
- [**Latest Configuration UI** (0.17.11) 🚀](https://dev.config-ui.demo.trustgraph.ai/)
...
| ------------ | --------------- |
| Latest | [0.17.11](https://github.com/trustgraph-ai/trustgraph/releases/download/v0.17.11/deploy.zip) |
