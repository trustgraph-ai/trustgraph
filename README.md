...
- [**Configuration Portal** (Latest 0.20.5) 🚀](https://dev.config-ui.demo.trustgraph.ai/)
...
| ------------ | --------------- |
| Latest | [0.20.5](https://github.com/trustgraph-ai/trustgraph/releases/download/v0.20.5/deploy.zip) |
