...
- [**Configuration Portal** (Latest 0.19.6) 🚀](https://dev.config-ui.demo.trustgraph.ai/)
...
| ------------ | --------------- |
| Latest | [0.19.6](https://github.com/trustgraph-ai/trustgraph/releases/download/v0.19.6/deploy.zip) |
