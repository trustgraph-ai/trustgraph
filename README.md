...
- [**Configuration Portal** (Latest 0.19.1) 🚀](https://dev.config-ui.demo.trustgraph.ai/)
...
| ------------ | --------------- |
| Latest | [0.19.1](https://github.com/trustgraph-ai/trustgraph/releases/download/v0.19.1/deploy.zip) |
