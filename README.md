...
- [**Configuration Portal** (Latest 0.20.2) 🚀](https://dev.config-ui.demo.trustgraph.ai/)
...
| ------------ | --------------- |
| Latest | [0.20.2](https://github.com/trustgraph-ai/trustgraph/releases/download/v0.20.2/deploy.zip) |
