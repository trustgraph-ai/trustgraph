...
```
pip3 install trustgraph-cli==0.15.5
```
...
| ------------ | --------------- |
| Latest | [0.15.5](https://github.com/trustgraph-ai/trustgraph/releases/download/v0.15.5/deploy.zip) |
| Stable | [0.15.5](https://github.com/trustgraph-ai/trustgraph/releases/download/v0.15.5/deploy.zip) |
