---
layout: default
title: "Python API Yeniden Düzenleme Teknik Özellikleri"
parent: "Turkish (Beta)"
---
...
**Tüm arayüzler için aynı URL**: `Api(url="http://localhost:8888/")`, tüm arayüzler için geçerlidir.
...
Format: `ws://localhost:8888/api/v1/socket?token=<token>`
