---
layout: default
title: "Especificación Técnica de Refactorización de la API de Python"
parent: "Spanish (Beta)"
---
...
**Misma URL para todas las interfaces:** `Api(url="http://localhost:8888/")` funciona para todas.
