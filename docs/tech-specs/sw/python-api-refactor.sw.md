---
layout: default
title: "Vipangilio vya Kisaikolojia la API ya Python"
parent: "Swahili (Beta)"
---
...
**URL moja kwa kila aina ya muunganisho**: `Api(url="http://localhost:8888/")` inafanya kazi kwa aina zote.
...
Muundo: `ws://localhost:8888/api/v1/socket?token=<token>`
